            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <i class="fa-solid fa-building" style="margin-right: 8px"></i>
                        <span class="side-menu__label">Tests</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('fitness.test.index') }}" class="slide-item">Create Test</a>
                        </li>
                ...
                {{-- test lavel manage --}}
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('fitness.test.level.index') ? 'has-link' : '' }}"
                        href="{{ route('fitness.test.level.index') }}">

                        <span class="icon-wrapper">
                            <i class="fa-solid fa-turn-up" style="margin-right: 8px"></i>
                        </span>

                        <span class="side-menu__label">Tests Lavel</span>
                    </a>
                </li>
