...
use App\Http\Controllers\Web\Backend\FitnessTestLevelController;
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('fitness/test/levels')->name('fitness.test.level.')->group(function () {
        Route::get('/', [FitnessTestLevelController::class, 'index'])->name('index');     // list (datatable + view)
        Route::post('/store', [FitnessTestLevelController::class, 'store'])->name('store'); // save new
        Route::get('/edit/{id}', [FitnessTestLevelController::class, 'edit'])->name('edit'); // edit form
        Route::post('/update/{id}', [FitnessTestLevelController::class, 'update'])->name('update'); // update record
        Route::delete('/delete/{id}', [FitnessTestLevelController::class, 'destroy'])->name('delete'); // delete
    });
